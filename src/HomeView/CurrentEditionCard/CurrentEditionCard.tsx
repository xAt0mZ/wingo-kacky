...
export function CurrentEditionCard() {
  ...
  return (
    <div className="flex flex-row items-end justify-between gap-2.5 self-stretch rounded-2xl bg-gray-gold p-4">
      <div className="flex shrink-0 grow basis-0 flex-col items-start justify-end gap-1">
